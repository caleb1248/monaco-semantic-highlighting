...
import { createSemanticTokensProvider } from "../semantic-tokens";
  ...
  function registerProviders(): void {
    ...
    if (true) {
      providers.push(
        ...
        //   modeId,
        //   createSemanticTokensProvider(modeId, new languageFeatures.SemanticTokensAdapter(worker))
        // )
        languages.registerDocumentSemanticTokensProvider(
          modeId,
      ...
      console.log("semantic tokens provider working!");
    }
  }
