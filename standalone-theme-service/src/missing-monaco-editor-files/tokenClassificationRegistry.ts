...
import { Color } from "monaco-editor-core/esm/vs/base/common/color.js";
import { Emitter, Event } from "monaco-editor-core/esm/vs/base/common/event.js";
import { IJSONSchema, IJSONSchemaMap } from "monaco-editor-core/esm/vs/base/common/jsonSchema.js";
import * as nls from "monaco-editor-core/esm/vs/nls.js";
import * as platform from "monaco-editor-core/esm/vs/platform/registry/common/platform.js";
import { IColorTheme } from "monaco-editor-core/esm/vs/platform/theme/common/themeService.js";
...
export namespace TokenStyle {
  export function toJSONObject(style: TokenStyle): any {
    return {
      _foreground:
        style.foreground === undefined ? null : Color.Format.CSS.formatHexA(style.foreground, true),
