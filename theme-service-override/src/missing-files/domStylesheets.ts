...
import { DisposableStore, toDisposable, IDisposable } from "vscode/vscode/vs/base/common/lifecycle";
import { getWindows, sharedMutationObserver } from "vscode/vscode/vs/base/browser/dom";
